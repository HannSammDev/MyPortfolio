...
export const Technologies = () => {
    ...
    return (
      <>
        <div className="h-0" id="technologies"></div>
        <div className="mb-10 b">
          <div className="card">
            <Card
              title={
                <span className="text-blue-800 text-2xl  font-bold drop-shadow-md">
                  TECHNOLOGIES
                </span>
              }
              className="border border-blue-500 m-5 p-5 bg-black/10 backdrop-blur-md dark:bg-gray-900/10 dark:backdrop-blur-md"
            >
