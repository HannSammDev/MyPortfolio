        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button
              ...
              className="social-btn transition-transform hover:scale-110 p-button-rounded p-button-outlined border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-white focus:ring-2 focus:ring-blue-200 rounded-full p-1"
            ...
            <Button
              ...
              className="social-btn transition-transform hover:scale-110 p-button-rounded p-button-outlined border-red-500 text-red-500 hover:bg-red-500 hover:text-white focus:ring-2 focus:ring-red-300 rounded-full p-1"
