        ...
        <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-lg xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
          ...
          <div className="mt-4 md:mt-0">
            ...
            <p className="text-justify mb-6 font-light text-gray-300 md:text-lg">
              I'm Sam, a BS Information Technology graduate who has been
              building websites and web systems since college. My passion for
              development led me to a Software Developer Internship, where I
              delivered real solutions in a professional setting.
              <br />
              <br />
              Since graduating in 2025, I've kept building — driven by a genuine
              love for growth. I'm a developer who is hungry to learn, eager to
              build, and ready to make an impact.
            </p>
            <a
              href="#contact"
