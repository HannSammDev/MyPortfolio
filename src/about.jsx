...
export const About = () => {
    return (
      <>
        ...
        <section
          id="about"
          className="bg-white/10 backdrop-blur-md dark:bg-gray-900/10 dark:backdrop-blur-md"
        >
          <div className="flex items-center mb-6">
            <div className="flex-grow border-t border-blue-600"></div>
            <h2 className="mx-4 font-bold text-4xl text-blue-800 whitespace-nowrap">
              About
            </h2>
            <div className="flex-grow border-t border-blue-600"></div>
          </div>
          <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-lg xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div className="mt-4 md:mt-0">
              ...
              <p className="text-justify mb-6 font-light text-gray md:text-lg dark:text-gray-400">
                ...
                clean, fast, and responsive websites and applications. Whether
                it's designing user interfaces or building out features behind
                the scenes, I enjoy turning ideas into real, working products.
                <br />
                <br />
                From planning and prototyping to coding and deployment, I take
                pride in delivering high-quality solutions that are both
                functional and user-friendly.
                <br />
                <br />
                I'm excited to collaborate and help bring your vision to
